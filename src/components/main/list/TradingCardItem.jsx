...
const TradingAnimalModalItem = ({ images, location, username, dated, price, dob, type, phone }) => {
...
const TradingCardItem = ({ images, location, username, dated, price, dob, type, phone }) => {
