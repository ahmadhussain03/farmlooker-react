...
const Salaries = () => {
    ...
    const handleWorkerChange = e => {
        ...
        const workerIndex = workers.findIndex(w => w.value == e.target.value)
        if(workerIndex != -1){
    ...
    return (
        <div className="flex w-1/2 items-center justify-around">
            <Form errors={errors} isPadded={false} onSubmit={handleOrderFeed}>
                ...
                <FormGroup>
                    <Input type="number" error={errors?.data?.weight} value={weight} onChange={handleWeightChange} placeholder="Weight"></Input>
                </FormGroup>
                <FormGroup>
