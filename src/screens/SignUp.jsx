...
const SignUp = ({setLogin}) => {
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            const response = await axios.post("register", {email, password, first_name: firstName, last_name: lastName, password_confirmation: confirmPassword, experience, device_name: browserName, device_token: "myToken", phone_no: `+${phoneCode}${phone}`})
                ...
                <div className="flex flex-row justify-center items-center space-x-1">
                    <div className="w-1/3">
                        <div className="flex flex-col content-start space-y-0">
                            ...
                            <select value={phoneCode} onChange={(e) => handlePhoneCodeChange(e)} className={`rounded-md bg-white p-2 border-l border-r border-t border-b focus:border-primary outline-none transition border-gray-800`} >
